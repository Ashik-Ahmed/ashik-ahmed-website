...
import { TwitterIcon, DribbbleIcon, GithubIcon, LinkedInIcon, PinterestIcon, SunIcon, MoonIcon } from '../Icons/Icons';
...
const Navbar = () => {
    ...
    return (
        <header className='w-full px-32 py-4 font-medium flex items-center justify-between dark:text-light z-10 lg:px-16 md:px-12 sm:px-8 fixed top-0 left-0 sm:dark:bg-transparent sm:bg-transparent dark:bg-dark bg-light'>
            ...
            <div className='w-full flex justify-between items-center lg:hidden'>
                ...
                <nav className='flex items-center justify-center flex-wrap'>
                    <motion.a href='https://github.com/Ashik-Ahmed' target='_blank'
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                    ...
                    <motion.a href='https://twitter.com/AshikAh61134446' target='_blank'
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className='w-6 mx-3 sm:mx-1'>
                        <TwitterIcon />
